...
public class GarageCustomisationView extends AbstractControllableView implements MouseListener{
    ...
    public void updateView() {
        ...
        drawBackground(graphics, model.getDrawCheap());
        
        drawCarPark(graphics, model.getDrawCheap());
    ...
    private void drawCarPark(Graphics graphics, boolean drawCheap) {
        ...
        drawProps(graphics, carpark_topleft_x, carpark_topleft_y - 40, model.getDrawCheap());
