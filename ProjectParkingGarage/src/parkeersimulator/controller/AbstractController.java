...
public abstract class AbstractController {
	...
	public enum ActionType {
		...
		PARKINGGARAGE_PASSWEEK_AMOUNT, PARKINGGARAGE_PASSWEEKEND_AMOUNT, PARKINGGARAGE_PASSEVENTWEEK_AMOUNT, PARKINGGARAGE_MAXPASS_AMOUNT,
		...
		FINANCE_PAYMENTTIMEFRAME_AMOUNT,
		FINANCE_ADHOC_COSTPERTIMEFRAME_AMOUNT, FINANCE_RESERVATION_COSTPERTIMEFRAME_AMOUNT, FINANCE_PASSHOLDER_COSTPERMONTH_AMOUNT,
		FINANCE_ENTRANCECOST_AMOUNT, FINANCE_TICKETMACHINECOST_AMOUNT, FINANCE_EXITCOST_AMOUNT,
		FINANCE_PLACECOST_AMOUNT, FINANCE_ROWCOST_AMOUNT, FINANCE_FLOORCOST_AMOUNT,
		FINANCE_MAINTENANCECOSTS_AMOUNT,
		LAYOUT_ADD_FLOOR, LAYOUT_ADD_ROW, LAYOUT_ADD_PLACE
	};
	...
	public enum ControllerType {PARKINGGARAGE, FINANCE, TIME, LAYOUT}
